...
import com.wy.phonemedia.view.VitamioVideoView;
...
public class VitamioVideoPlayer extends AppCompatActivity implements View.OnClickListener {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SHOW_SPEED:
                    String speed=mUtils.getNetSpeed(VitamioVideoPlayer.this);
...
//        mVideoView.setMediaController(new MediaController(this));
    ...
    private void setData() {
        if (mediaItems != null && mediaItems.size() > 0) {
            ...
            Toast.makeText(VitamioVideoPlayer.this, "没有数据", Toast.LENGTH_SHORT).show();
        }
    }
...
//                    Toast.makeText(SystemVideoPlayer.this, "视频卡结束了。。。", Toast.LENGTH_SHORT).show();
    ...
    class MyOnPreparedListener implements MediaPlayer.OnPreparedListener {
        ...
        public void onPrepared(MediaPlayer mp) {
             ...
             */
            //1.获取视频的总时长
            int totalSize = (int) mVideoView.getDuration();
            //2.设置给seekBar
...
//            Toast.makeText(SystemVideoPlayer.this, "播放完成了", Toast.LENGTH_SHORT).show();
            ...
            if (mediaItems != null && mediaItems.size() > 0) {
                if (position < mediaItems.size() - 1) {
                    ...
                    Toast.makeText(VitamioVideoPlayer.this, "大姐，后面没有视频了！", Toast.LENGTH_SHORT).show();
                    btnVideoStartPause.setBackgroundResource(R.drawable.btn_video_start_selector);
                }
            } else if (uri != null) {
                btnVideoStartPause.setBackgroundResource(R.drawable.btn_video_start_selector);
